...
# 1. LOAD DATA
# ======================
data = pd.read_csv("fraud_detectionupdated/creditcard.csv")
...
# 7. SAVE MODEL
# ======================
joblib.dump(model, "fraud_detectionupdated/fraud_xgb_model.pkl")
joblib.dump(scaler, "fraud_detectionupdated/scaler.pkl")
...
def predict_transaction(transaction_dict):
    model = joblib.load("fraud_detectionupdated/fraud_xgb_model.pkl")
    scaler = joblib.load("fraud_detectionupdated/scaler.pkl")
